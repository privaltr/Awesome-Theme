...
function signals:init(args)
	...
	--screen.connect_signal("tag::history::update", function(c) naughty.notify({ text = "press" }) end)
	--screen.connect_signal("mouse::enter", function(c) naughty.notify({ text = "press" }) end)
	--screen.connect_signal("property::position", function(c) naughty.notify({ text = "press" }) end)
  --screen.connect_signal("mouse::enter", function () screen.emit_signal("request::activate", "screen-switch", {raise = true}) end)
